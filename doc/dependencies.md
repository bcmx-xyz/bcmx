...
These are the dependencies currently used by BCMX. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/bcmx
Keybase  - https://keybase.io/team/bcmx/
