...
const QString BITCOIN_IPC_PREFIX("bcmx:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bcmx-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bcmx-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bcmx-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bcmx: links
...
//
// OSX-specific way of handling bcmx: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bcmx: URIs
