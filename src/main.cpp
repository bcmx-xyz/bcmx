...
#if defined(NDEBUG)
# error "BCMX cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BCMX Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BCMX also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BCMX also requires low S in sigs
